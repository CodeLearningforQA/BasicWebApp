...
public class RegistrationDAO implements Serializable {
    ...
    public boolean deleteAccount(String username) throws ClassNotFoundException, SQLException {
        //paramenter is username, since it's PK
    ...
    public boolean updatePassRoleAccount(String username, String password, boolean role)
        throws SQLException, ClassNotFoundException {
    ...
    try {
        ...
        if (con != null) {
            ...
            stm.setBoolean(2, role);   // SQL Server: bit (0/1) map OK với boolean
            ...
            if (row > 0){
                 result=true;
            } // true nếu update được ít nhất 1 dòng
        }
    } finally {
        // Close stm --> con
