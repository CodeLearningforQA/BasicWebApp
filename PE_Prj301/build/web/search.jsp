...
<html>
    ...
    <body>
        <% 
            ...
            if(cookies!=null) {
            Cookie newCookie=cookies[cookies.length-1];
        ...
        <form action="MainController">
            Search value <input type="text" name="txtSearchValue" 
                                value="${param.txtSearchValue}" /><br> <%-- take them name txt... from SearchLatsNameServlet --%>
            ...
            <table border="1">
                ...
                <tbody>
                    <c:forEach items="${result}" var="dto" varStatus="counter">
                        <!-- Post because there is password -->
                    <form action="MainController" method="POST">
                        ...
                        <tr>
                            ...
                            <td>
                                <%-- value is the url of controller--%>
    ...
    <!-- Khi load file jsp, khi dó chua ai nhap thi value==null -->
    <%
        String searchValue = request.getParameter("txtSearchValue");
        if (searchValue != null) {
            List<RegistrationDTO> result
                    = (List<RegistrationDTO>) request.getAttribute("SEARCH_RESULT");
            //ctrl +Space+Enter --> line 7
